...
CREATE TABLE `order` (
  ...
  KEY `1_idx` (`employee_code`),
  CONSTRAINT `2` FOREIGN KEY (`employee_code`) REFERENCES `users` (`user_code`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2021-11-08 22:56:48
