...
namespace BookHunterManagment.Classes
{
    class ConnectionToDataBase
    {
        ...
        {
            string path = "server=localhost;user=root;password=4321;database=bookhunter_database";
        ...
        public static List<Classes.Book>BookItem(string Find, string Sort)
        {
            ...
            while(reader.Read())
            {
                ...
                Classes.Book book = new Book
                {
                    ...
                    bookimage = new BitmapImage(new Uri("C:\\Users\\Алмаз\\Desktop\\Алмазику\\Книги\\" + reader.GetString(12)))
                };
                books.Add(book);
            }
            return books;
