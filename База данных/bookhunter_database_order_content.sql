...
CREATE TABLE `order_content` (
  ...
  `count` int NOT NULL,
  KEY `order_key_idx` (`order_code`),
  KEY `book_key_idx` (`book_code`),
  CONSTRAINT `book_key` FOREIGN KEY (`book_code`) REFERENCES `books` (`book_code`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `order_key` FOREIGN KEY (`order_code`) REFERENCES `order` (`order_code`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `order_content` VALUES (4,5,2);
